    ...
    >
      ...
      >
        ...
        <div className="flex p-4">
          ...
          <label className="ml-2 text-sm font-medium dark:text-gray-300 text-white" htmlFor="contact-form-checkbox">By checking this box you agree with our <a href="" className="text-blue-600 dark:text-blue-500 hover:underline">Privacy Policy</a></label>
        </div>
