import evolveIcon from '../assets/evolve-icon.png'

const Services = () => {
  return (
    <div name="services" className="w-full min-h-screen text-white">
    <div className="flex flex-col justify-center items-center w-full h-full pb-14">
      <div className="font-bold border-b-2 text-4xl md:text-5xl inline">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 p-4 gap-4 max-w-[1000px] text-center pt-12">
          <div className="p-4">
            <img className='m-auto' src={evolveIcon} alt="Icon of evolve logo" width={60}/>
